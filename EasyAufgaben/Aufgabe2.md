# Das Projekt: „Smart Bus Stop“ (Konsole)

Wir verzichten am Anfang bewusst auf bunte Grafiken und konzentrieren uns auf das, was einen echten Software-Entwickler ausmacht: Logik und Daten.
...
- Lerneffekt: Rechnen mit Zahlen (int) in C#.

## Phase 3: Das Verspätungs-Warnsystem (Logik)
In der Realität gibt es oft Stau. Baue eine Logik ein: Wenn die Wartezeit mehr als 5 Minuten beträgt, soll eine Warnmeldung erscheinen: „Achtung: Hohes Verkehrsaufkommen!“

- Profi-Bonus: Versuche, die Warnung in einer anderen Farbe (z.B. Rot)  auszugeben.
- Lerneffekt: Logische Entscheidungen (if-else).
